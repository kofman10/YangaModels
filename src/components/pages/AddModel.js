...
const newModel = { id,firstname,lastname,email,mobileNumber,address,city,instagram,Talent,sex };
...
<li>On no occasion should you upload selfies or nudes</li>
 ...
 <button onClick={createModel} type="submit" className="border bg-[#B4917E] uppercase font-bold rounded-md ml-5 py-3 px-5 mt-5 mb-10"> Submit application</button>
</form> );
}
